...
public class App {
    ...
    public static void configureRoutes(Javalin app) {
        ...
        app.get(Landingpg.URL, new Landingpg());
        app.get(Atrisk.URL, new Atrisk());
        app.get(Donation.URL, new Donation());
        app.get(level3page.URL, new level3page());
        ...
        app.post(Atrisk.URL, new Atrisk());
        app.post(level3page.URL, new level3page());
    }
